...
COPY files/ /
RUN rm -f /data/upload/bootstrap.php && \
    rm -f /data/upload/scp/login.php && \
    rm -f /data/upload/api/http.php && \
    rm -f /data/upload/include/api.tickets.php && \
    #rm -f /data/upload/include/class.api.php && \
    #rm -f /data/upload/include/class.thread.php && \
    #rm -f /data/upload/include/class.ticket.php && \
    cp /data/bin/imis-bootstrap.php /data/upload/bootstrap.php && \
    cp /data/bin/imis-login.php /data/upload/scp/login.php &&\
    cp /data/bin/api.http.php /data/upload/api/http.php && \
    cp /data/bin/include.api.tickets.php /data/upload/include/api.tickets.php
    #cp /data/bin/include.class.api.php /data/upload/include/class.api.php && \
    #cp /data/bin/include.class.thread.php /data/upload/include/class.thread.php && \
    #cp /data/bin/include.class.ticket.php /data/upload/include/class.ticket.php
VOLUME ["/data/upload/","/var/log/nginx"]
EXPOSE 80
